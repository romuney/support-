...
```
python3 make_gif.py typing-sheet.png --out out/bulli_typing.gif \
        --ms 80 --align --freeze-top 0.30
```
...
**Что реально помогло — заморозка верха кадра.** Кепка с надписью берётся
