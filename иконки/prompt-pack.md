...
Вырезание фона пришлось переделать, и это оказалось не мелочью, а сменой
правила: старая заливка от краёв на пороге 60 выедала собаке грудь, а на
пороге 20 оставляла серые лоскуты у лапы и у замка. Разделяет их не яркость,
а **насыщенность**: фон нейтральный (0–6), тень на кремовой шерсти цветная
(медиана 40). Замер и новый алгоритм — в докстроке `sheet.key_background`.
Сборка GIF гоняет ту же функцию, поэтому анимация пересобрана как
