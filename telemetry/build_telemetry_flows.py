...
# Значение — из трассы ядра 02.09 («id бота: … (@bully)»): узел «Who am I»
# печатает его в каждом прогоне, и в интерфейсе Mattermost его больше нет.
BOT_USER_IDS = ["r4k3wdjzc78dfb3ormsg8e3q3h"]
